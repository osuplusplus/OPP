      ...
      <div className="max-h-[min(34rem,60vh)] overflow-y-auto p-3.5">
        {folder.entries.length ? (
          <div className="grid grid-cols-2 gap-2.5 lg:grid-cols-3 2xl:grid-cols-4">
            {/* 支持的桌面宽度保持三列，宽屏提升为四列；卡片高度仍由比例决定。 */}
