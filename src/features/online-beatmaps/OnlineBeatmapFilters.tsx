              ...
              <>
                <div className="space-y-5 pt-4">
                  <div className="border-y border-[var(--line-subtle)]">
                    ...
                    <FilterRow label="其他"><TextOption active={query.extras.includes("video")} onClick={() => toggleExtra("video")}>有视频</TextOption><TextOption active={query.extras.includes("storyboard")} onClick={() => toggleExtra("storyboard")}>有故事板</TextOption></FilterRow>
