...
vi.mock("../../shared/lib/tauri", () => ({ desktopApi: { openDownloadedPath: vi.fn(), openExternal: vi.fn() } }));
...
beforeEach(() => { vi.resetAllMocks(); vi.mocked(desktopApi.openDownloadedPath).mockResolvedValue(undefined); vi.mocked(desktopApi.openExternal).mockResolvedValue(undefined); });
