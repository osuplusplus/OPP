...
pub(crate) use crate::{
    features::{
        ...
        collections::{
            ...
            enable_collection_stable_sync, export_collection_share, get_collection_artwork,
            get_collection_backup_status, get_collection_download_items,
            get_collection_entry_scores, get_collection_manager_status, get_collection_record,
            get_collection_sync_status, import_collection_archive, import_collection_share,
            install_collection_downloads, list_collection_summaries, list_collections,
            open_collection_downloads, preview_collection_share, query_collection_browser,
            query_collection_entries, refresh_collection_summaries, refresh_collections,
            remove_collection_entry, rename_collection, restore_collection_backup,
        ...
        game_session::{
            choose_game_replay_files, get_game_session_status, get_game_status,
            inspect_game_replay, list_game_media, open_beatmap_files, open_lazer_beatmap,
            open_media_in_explorer, read_game_replay, read_game_screenshot,
        ...
        local_analysis::{
            ...
            get_local_artwork_sample, get_local_beatmap_audio, get_local_beatmap_background,
            get_local_beatmap_detail, get_local_beatmap_path, get_local_beatmap_set,
            get_local_index_status, get_local_library_storage_status, get_local_skin_asset,
            get_local_skin_detail, get_local_skin_preview, get_local_sources, get_local_summary,
            migrate_local_library_database, pick_random_local_beatmap_set,
            query_local_beatmap_presence, query_local_beatmap_sets, query_local_beatmaps,
        ...
        local_scores::refresh_local_scores,
        music_player::{
        ...
        tosu::{
            ...
            start_tosu, stop_tosu,
        },
        tournament_pools::{
            acknowledge_tournament_link, get_pending_tournament_link, get_tournament_pool,
            open_tournament_pool, repair_tournament_pool_metadata, sync_tournament_pool_collection,
        },
        trainer::generate_trainer_beatmap,
        update::{check_for_updates, download_and_install_update, ignore_update_version},
        view_trainer::commands::{
            view_trainer_generate, view_trainer_get_timeline, view_trainer_import,
        },
    },
    infrastructure::logging::{
        get_log_directory, list_log_files, open_log_directory, open_log_file, write_client_log,
    },
...
macro_rules! handler {
    () => {
        tauri::generate_handler![
            ...
            get_collection_entry_scores,
            get_collection_artwork,
            refresh_local_scores,
            music_state,
            music_location,
            music_queue_page,
            music_control,
            ...
            sync_tournament_pool_collection,
            get_pending_tournament_link,
            acknowledge_tournament_link,
            ...
            enable_collection_stable_sync,
            write_stable_collections,
            get_collection_manager_status,
            set_collection_manager_path,
            get_collection_backup_status,
            create_collection_backup,
            write_lazer_collections,
            ...
            query_local_beatmap_presence,
            get_local_library_storage_status,
            migrate_local_library_database,
            retry_local_database,
            locate_local_database,
            scan_local_source,
